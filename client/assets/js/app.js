...
const App = {
    ...
    handleRoomState(data) {
      ...
      // Actualizar componente de sala
      this.components.room.updateState(data);
    ...
    handleGameState(data) {
      ...
      // Actualizar fase en el componente Room
      this.components.room.updatePhase(data.currentPhase);
...
handleHandResult(data) {
    ...
    UIUtils.showMessage('La mano ha terminado. Selecciona al ganador y haz clic en "Iniciar nueva mano".', 'system');
    ...
    // Destacar control de mano
    const handControl = document.getElementById('handControl');
    handControl.style.display = 'block';
    handControl.classList.add('active');
    ...
    // Destacar botón de siguiente mano
